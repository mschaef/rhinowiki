...
<ul>
<li>2-finger trackpad scrolling.
<li>Sudden motion sensing for the disk. (Is this done by the
    disk itself with a built in motion sensor or by the
    motherboard/CPU?)
<li>Standard Bluetooth
<li>A minor speed bump: the peak CPU is now a 1.42GHz G4 with a 142MHz bus.
</ul>
...
bus" <i>(fast? Dell's
<a href="http://www1.us.dell.com/content/products/features.aspx/inspn_1200?c=us&cs=19&l=en&s=dhs">$500
Inspiron 1200</a> runs its system bus at 400MHz)</i> and "brilliant 1024 by 768 pixel
resolution" <i>(maybe it was brilliant five
years ago)</i>. 
